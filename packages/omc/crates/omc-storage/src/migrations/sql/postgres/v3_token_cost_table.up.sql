CREATE TABLE token_cost (
    ...
    reasoning_cost_micros BIGINT NOT NULL DEFAULT 0,
    cache_read_cost_micros BIGINT NOT NULL DEFAULT 0,
    cache_write_cost_micros BIGINT NOT NULL DEFAULT 0,
    audio_input_cost_micros BIGINT NOT NULL DEFAULT 0,
    video_input_cost_micros BIGINT NOT NULL DEFAULT 0,
    image_input_cost_micros BIGINT NOT NULL DEFAULT 0,
