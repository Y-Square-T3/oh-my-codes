...
describe("loadJsonFile", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "oh-my-codes.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "oh-my-codes.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "oh-my-codes.jsonc"), jsoncContent, "utf-8")
