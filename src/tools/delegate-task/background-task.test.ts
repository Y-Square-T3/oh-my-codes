...
} = require("../../shared/session-category-registry")
    ...
    testFn(
      ...
      async () => {
        ...
        const states = new Map([
          [
            "bg_first",
            { reads: 0, abortOnFirstRead: true, sessionID: "ses_first" },
          ],
          [
            "bg_second",
            { reads: 0, abortOnFirstRead: false, sessionID: "ses_second" },
          ],
        ])
        let launchCount = 0
        const manager = {
