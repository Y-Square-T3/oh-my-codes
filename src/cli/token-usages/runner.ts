...
async function runStatus(service: AuditService, json: boolean): Promise<number> {
...
export async function runTokenUsages(options: TokenUsagesOptions): Promise<number> {
