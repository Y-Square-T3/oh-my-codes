/**
 * Unified system directive prefix for oh-my-codes internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OH-MY-CODES - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: OH-MY-CODES"
 ...
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: OH-MY-CODES - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the oh-my-codes system directive prefix.
