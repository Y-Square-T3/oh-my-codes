...
describe("migrations sidecar", () => {
  ...
  describe("getSidecarPath", () => {
    test("appends .migrations.json to the config path", () => {
      expect(
        getSidecarPath("/home/user/.config/opencode/oh-my-codes.json"),
      ).toBe("/home/user/.config/opencode/oh-my-codes.json.migrations.json")
    })

    test("works for jsonc configs too", () => {
      expect(getSidecarPath("/home/user/oh-my-codes.jsonc")).toBe(
        "/home/user/oh-my-codes.jsonc.migrations.json",
      )
    })
  })
  ...
  describe("readAppliedMigrations", () => {
    test("returns an empty set when no sidecar exists", () => {
      const configPath = join(workdir, "oh-my-codes.json")
  ...
  describe("writeAppliedMigrations", () => {
    ...
    test("creates parent directories if they do not exist yet", () => {
      ...
      const configPath = join(nested, "oh-my-codes.json")
    ...
    test("round-trips via readAppliedMigrations", () => {
      const configPath = join(workdir, "oh-my-codes.jsonc")
