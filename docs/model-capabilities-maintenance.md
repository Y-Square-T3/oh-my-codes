...
- Built-in oh-my-codes agent/category requirement models must use canonical model IDs.
- Aliases exist only to preserve compatibility with historical oh-my-codes names or provider-specific decorations.
