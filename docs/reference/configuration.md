...
Run `bunx oh-my-codes install` for guided setup. Run `opencode models` to list available models.
...
Run `bunx oh-my-codes doctor --verbose` to see effective model resolution for your config.
